...
export const getPaymentDetails = (filters = {}) => ({
    type: types.GET_PAYMENT_DETAILS,
    payload: axios.get(`${window.location.origin}/api/get-payment-details?${queryString.stringify(filters, {
        arrayFormat: "index"
    })}`)
})
