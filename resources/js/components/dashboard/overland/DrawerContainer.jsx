...
import {
    downloadContract, fetchOverland, downloadInvoice, fetchCard,
    getCard, setCard
} from '../../../redux/overland/actions';
...
const mapStateToProps = (state) => {
    return {
        loadingDownload: state.overland.loadingDownload,
        loading: state.overland.loading,
        data: state.overland.current,
        card: state.overland.card,
    };
};
