        ...
        <div class="container" style="font-family: 'Century Gothic', Tahoma, Arial;">
            ...
            <div class="statusorder"
                ...
                <div class="boxstatusorder" style="width: 25%; padding:10px; box-sizing: border-box;">
                    ...
                    <span class="vrc-email-summ-values">{{$overland->id}}</span>
                </div>
                <div class="boxstatusorder" style="width: 25%; padding:10px; box-sizing: border-box;">
                    <span class="vrc-email-summ-lbl"
                        style="display: block; font-weight: bold; margin-bottom: 2px; font-size: 1.1em;">
                    ...
                    <span class="vrc-email-summ-values">{{$overland->token}}</span>
                </div>
                <div class="boxstatusorder" style="width: 25%; padding:10px; box-sizing: border-box;">
                    <span class="vrc-email-summ-lbl"
                        style="display: block; font-weight: bold; margin-bottom: 2px; font-size: 1.1em;">
                    ...
                    <span class="vrc-email-summ-values">{{$overland->created_at}}</span>
                </div>
            </div>
            <div class="persdetail">
                ...
                <p>Name: {{$overland->client->name}}</p>
                <p>Email: {{$overland->client->email}}</p>
                <p>Phone: {{$overland->client->phone}}</p>
                <p>Identity card / passport: {{$overland->client->cc}}</p>
            </div>
            <div class="hiremainbox">
                <h4 style="font-size: 18px; font-weight: bold; margin-bottom: 12px;">
                    Vehicle: {{$overland->vehicle->title}}
                </h4>
                <div class="hirecar" style="display: flex; flex-wrap: wrap;">
                    <div class="hiredate"
                        ...
                        <p style="padding: 0; margin: 0px 0 5px; display: inline-block; margin-right: 10px;">
                            ...
                            <span class="Stile9" style="font-size: 14px;">{{$overland->pickup_date}}</span>
                        </p>
                        <p style="padding: 0; display: inline-block;">
                            <span class="Stile12" style="font-size: 14px;font-weight: bold;">
                                Pickup Location
                            </span>
                            <span class="Stile9" style="font-size: 14px;">{{$overland->pickup_place}}</span>
                        </p>
                    </div>
                    <div class="hiredate"
                        style="flex: 1; border:1px solid #eee; border-radius:4px; padding:10px; margin:0 10px 0 0; background:#fbfbfb;">
                        <p style="padding: 0; margin: 0px 0 5px; display: inline-block; margin-right: 10px;">
                            ...
                            <span class="Stile9" style="font-size: 14px;">{{$overland->return_date}}</span>
                        </p>
                        <p style="padding: 0; display: inline-block;">
                            <span class="Stile12" style="font-size: 14px;font-weight: bold;">
                                Drop Off Location
                            </span>
                            <span class="Stile9" style="font-size: 14px;">{{$overland->return_place}}</span>
                        </p>
                    </div>
                </div>
                <div class="hireorderdetail" style="margin-top: 15px;">
                    ...
                    <div style="font-size: 14px;">
                        <span>Vehicle</span>
                        <div style="float: right">{{$overland->vehicle_price}} EUR</div>
                    </div>


                    @foreach ($overland->extras as $extra)
                    <div style="font-size: 14px; ">
                        <span>{{$extra->name}}</span>
                        <span style="float: right">{{$extra->price * ($extra->type === "day" ?
                            $overland->days : 1)}} EUR</span>
                    </div>
                    @endforeach
                    ...
                    <div style="font-size: 14px;">
                        <span>Insurance</span>
                        <div style="float: right">{{$overland->insurance->price * $overland->days}} EUR</div>
                    </div>
                    ...
                    <div class="hireordata hiretotal"
                        ...
                        <div style="float:right;"><strong>{{$overland->price}} EUR</strong></div>
                    </div>
                </div>
            </div>
        </div>
