...
<body style="background-color: #e9ecef;">
    ...
    <div class="preheader"
        ...
        Thank You. Your reservation is almost done, confirm it here.
    </div>
    <!-- end preheader -->
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Tap the button below to confirm your reservation. If you didn't
                                create a reservation on <a href="https://cr-rent.com">CR Rent</a>, you can safely delete
                                this email.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" bgcolor="#7B2CBF" style="border-radius: 6px;">
                                                    <a href="https://cr-rent.com/confirmation/?token={{$token}}"
                                                        target="_blank"
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">If that doesn't work, copy and paste the following link in your
                                browser:</p>
                            <p style="margin: 0;"><a href=https://cr-rent.com/confirmation/?token={{$token}}"
                                    target="_blank">https://cr-rent.com/confirmation/?token={{$token}}</a></p>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;>
                            <p style=" margin: 0;">Regards,<br> CR Rent</p>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                            <p style="margin: 0;">Rua das Pretas, N.º 4, 2º E • 9000-049 Funchal • Portugal</p>
                            <p style="margin: 0;">Tlf [+351] 291 619 114 • Tlm [+351] 934 953 682 • <a
                                    href="https://cr-rent.com">www.cr-rent.com</a></p>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">You received this email because we received a reservation from this
                                email address. If you didn't book a product from CR Rent you can safely
                                delete this email.</p>
                        </td>
                    </tr>
                    <!-- end permission -->
