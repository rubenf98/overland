                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <h1 style="font-size: 24px;margin-bottom: 0px;">Resumo de comissões </h1>
                            ...
                            <ul>
                                ...
                                <li>{{$comission->agency->name}}: {{$comission->value}}€ ({{$comission->intermediary}})
                                </li>
                                @endforeach
                            </ul>
                            @else
                            <p>Não existem comissões pendentes</p>
                            @endif
