...
<body>
    ...
    <div class="vrc-emailc-wrap" style="max-width: 720px; background: #fff; border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; margin: 0 auto; padding: 24px;">
        <div class="vrc-emailc-logo" style="text-align: center; margin: 8px 0;">
            <img src="https://cr-rent.com/image/logo.png" alt="Logo" border="0" width="48" style="display: block; width: 120px; max-width: 120px; min-width: 120px; margin: auto">
        </div>
        ...
        <div class="container" style="font-family: 'Century Gothic', Tahoma, Arial;">
            ...
            <div class="statusorder" style="display: flex; border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; margin-bottom: 15px;">
                <div class="boxstatusorder" style="width: 25%; padding:10px; box-sizing: border-box;">
                    <span class="vrc-email-summ-lbl" style="display: block; font-weight: bold; margin-bottom: 2px; font-size: 1.1em;">
                        Order Number
                    </span>
            ...
            <div class="hiremainbox">
                ...
                <div class="hireorderdetail" style="margin-top: 15px;">
                    ...
                    <div class="hireordata hiretotal" style="margin:0 0 7px 0; margin: 10px 0 7px 0; color: #144D5C; border-top: 1px solid #ddd; padding: 10px 0 0 0; font-size: 16px; font-weight: bold;">
                        <span>
                            Total
                        </span>
